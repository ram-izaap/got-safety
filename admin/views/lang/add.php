             ...
             <input type="hidden" name="edit_id" id="edit_id" value="<?php echo $edit_id = (isset($form_data['id']))?$form_data['id']:""; ?>" /> 
				<div class="form-group">
					...
					* </span>
					...
					<div class="col-md-10">
						<input type="text" name="lang" class="form-control" value="<?php echo set_value('lang',$form_data['lang']); ?>">
						<span class="vstar" <?php echo form_error('lang', '<span class="help-block">', '</span>'); ?></span>
					</div>
				</div>
