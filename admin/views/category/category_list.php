		...
		<div class="col-lg-12">
			<div class="row">
              <div class="col-lg-12" style="margin-left: -10px;">
                <h1 class="pull-left"><b>Category</b></h1>
                </div>
				...
				<div class="col-lg-12" style="margin-left: -10px;">
					<ol class="breadcrumb">
						...
						<li class="active"><span>Category</span>
						</li>
					...
					<div class="clearfix">
						 ...
						 <div class="pull-right top-page-ui">
	                        ...
	                        <a href="<?php echo site_url('category/add_category');?>" class="btn btn-success">
	                            <i class="fa fa-plus-circle fa-lg"></i> New
	                        </a>
	                        <a onclick="return DeleteCheckedRow(this,'delete-category','category/category_delete');" class="btn btn-success">
