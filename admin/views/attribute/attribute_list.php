		...
		<div class="col-lg-12">
			<div class="row">
              <div class="col-lg-12" style="margin-left: -10px;">
                <h1 class="pull-left"><b>Attribute</b></h1>
                </div>
				...
				<div class="col-lg-12" style="margin-left: -10px;">
					<ol class="breadcrumb">
						...
						<li class="active"><span>Attribute</span>
						</li>
					...
					<div class="clearfix">
						 ...
						 <div class="pull-right top-page-ui">
	                        ...
	                        <a href="#"  onclick="add_attr_name()" class="btn btn-success">
	                            <i class="fa fa-plus-circle fa-lg"></i> New
	                        </a>
	                        <a href="<?php echo site_url('attribute/attribute_value');?>" class="btn btn-success">
	                            <i class="fa fa-plus-circle fa-lg"></i> Attribute Value List
	                        </a>
	                        <!--<a onclick="return DeleteCheckedRow(this,'delete-attribute','attribute/attr_delete');" class="btn btn-success">
		     ...
		     <input type="hidden" name="edit_id">
		      ...
		      <div class="form-group">
				...
				<div class="col-md-8">
					...
					<span class="vstar err" style="display:none;">The Attribute field is required.</span>  
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-2 pull-right">
					<input type="submit" class="form-control btn btn-primary" style="font-weight: bold; font-size:17px;" name="submit" id="save_attr_name" value="SAVE" />
				</div>
			  </div>
		  </form>
		</div>
