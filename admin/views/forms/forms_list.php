		...
		<div class="col-lg-12">
			<div class="row">
              <div class="col-lg-12" style="margin-left: -10px;">
                <h1 class="pull-left"><b>Safety forms</b></h1>
                </div>
				...
				<div class="col-lg-12" style="margin-left: -10px;">
					<ol class="breadcrumb">
						...
						<li class="active"><span>Safety Forms</span>
						</li>
					</ol>
					<div class="clearfix">
						 ...
						 <div class="pull-right top-page-ui">
	                        ...
	                        <a href="<?php echo site_url('forms/add_edit_forms');?>" class="btn btn-success">
	                            <i class="fa fa-plus-circle fa-lg"></i> New
	                        </a>
	                        <a onclick="return DeleteCheckedRow(this,'delete-forms','forms/forms_delete');" class="btn btn-success">
