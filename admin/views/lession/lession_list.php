				...
				<div class="col-lg-12" style="margin-left: -10px;">
					...
					<div class="clearfix">
						 ...
						 <div class="pull-right top-page-ui">
	                        ...
	                        <a href="<?php echo site_url('admin/jqslider/add_edit_jqslider');?>" class="btn btn-success">
	                            <i class="fa fa-plus-circle fa-lg"></i> New
	                        </a>
	                        <a onclick="return DeleteCheckedRow(this,'delete-jqslider','admin/jqslider/jqslider_delete');" class="btn btn-success">
