...
<li><span>Signature: <?php echo $img_url; ?></span> <span><img src="<?php echo $img_url.'signature/'.$result['sign'];?>" alt="<?php echo $result['employee_name']; ?>" height="120" width="250"></span></li>
</ul>
<div class="col-md-12">
