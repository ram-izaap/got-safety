...
$sandbox = TRUE;//$host_split[0] == 'sandbox' && $host_split[1] == 'domain' ? TRUE : FALSE;
 ...
 */
$api_username = $sandbox ? 'ramakrishnan.k_api1.izaaptech.com' : 'LIVE_API_USERNAME';
$api_password = $sandbox ? '1378031168' : 'LIVE_API_PASSWORD';
$api_signature = $sandbox ? 'As2dhtAWWw0lF9fr1q8VWYl2Of1XAMtEO2zlCbeWN7VoTOGnm2X7wRc5' : 'LIVE_API_SIGNATURE';
