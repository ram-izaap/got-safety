   <?php if(isset($this->session->userdata['shipping_info']['name']) && $this->session->userdata['shipping_info']['name']!=''): ?>
      ...
      <form action="#" name="shipping_information" id="shipping_information" method="post" class="form-horizontal" onsubmit="shipping_address_validation(); return false;">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <button class="btn btn-success btn-submit-fix btn-green" onclick="javascript:shipping_address_validation()" type="submit">
                         Save
                        </button>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
