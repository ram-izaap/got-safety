   ...
   <?php if(isset($this->session->userdata['billing_info']['name']) && $this->session->userdata['billing_info']['name']!=''){ ?>
      ...
      <div class="billing-details" id="billing_list">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 billing" data-form="checkout">
            ...
            <input type="hidden" name="billing_success" value="billing_success">
            <!--SHIPPING METHOD END-->
          </div>
        </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 billing" data-form="checkout">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  <div class="col-xs-12">
                    <input type="text" value="<?php echo $this->session->userdata['email1']; ?>" <?php echo (isset($this->session->userdata['email1']) && $this->session->userdata['email1']!='')?("readonly=readonly"):'';?> placeholder="E - Mail" class="form-control input-lg" id="email" name="email">
                  </div>
