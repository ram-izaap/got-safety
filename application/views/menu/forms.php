                        ...
                        <div class="report-details">
                        	<div class="reports-section clearfix">
                                <?php $i=1; foreach($all_data as $data) {  ?>
										<a target="_blank" href="<?php echo $img_url; ?>assets/images/frontend/safety_forms/<?php echo $data['pdf_file'];?>"  <?php if($i % 2 == 0) {  ?>class="i-reports R-mar0" <?php } else { ?> class="i-reports" <?php } ?>><span><?php echo $data['title']?> <br><small><?php echo $data['created_date']?></small></span></a>
								<?php  $i++;} ?>
