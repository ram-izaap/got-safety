<!-- Right Bar -->
                    ...
                    <?php /*   <h3>Attendance </h3>
                      ...
                      <h3>Select Your Poster Here</h3>

                      <div class="" data-nav="gs-recommended-lesson">
                          <ul>
							  <?php  foreach($this->data['list_data'] as $list){ ?>
								  
								  <li><a style="cursor:pointer" onclick="get_posters_list(<?php echo $list['id'];?>);"> <?php echo $list['title'];?></a></li>
...
<script>
	...
	function get_posters_list(id)
	{
	   $.ajax({

             url: '<?php echo base_url() ?>index.php/posters/get_posters_data/', 
             type: 'POST',
             dataType:'json',
             data: {'view_param': id},
