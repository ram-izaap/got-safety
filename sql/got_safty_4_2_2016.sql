...
--
-- Host: localhost
-- Generation Time: Feb 04, 2016 at 06:41 PM
...
INSERT INTO `lession_attachment` (`id`, `lession_id`, `language`, `f_name`, `is_active`) VALUES
(1, 1, 'English', 'image.png', 1),
(3, 2, 'Tamil', 'test1.jpg', 1),
(4, 2, 'Dutch', 'GotSafetyCom_Logo_CMYK_Final2.pdf', 1),
(9, 2, 'English', 'Form_11_New_Format_origanal(1).doc', 1);
...
INSERT INTO `webinars` (`id`, `title`, `link`, `video_file`, `created_date`, `is_active`) VALUES
(1, 'Sample', ' dnfndfndijjfbdijbfdbfdiuifdibf', 'test.mp3', '2016-01-29', 1),
(2, 'Test', ' asdfas', 'lasdf.mp3', '2016-01-29', 1),
(3, 'Test video upload', '    sads sdgfdsgffdgf dffd fghgfh', 'SampleVideo_1280x720_1mb1.mp4', '2016-02-01', 1);
